describe "Float#**", ->
  it "returns self raise to the other power", ->
    expect( R(2.3).exp(3  ).unbox() ).toBeCloseTo(12.167,0.00001)
    expect( R(5.2).exp(-1 ).unbox() ).toBeCloseTo(0.192307692307692,0.00001)
    expect( R(9.5).exp(0.5).unbox() ).toBeCloseTo(3.08220700148449, 0.00001)
    expect( R(9.5).exp(0xffffffff).to_s().unbox() ).toEqual 'Infinity'
