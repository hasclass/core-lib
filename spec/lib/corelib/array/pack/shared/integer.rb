...
describe :array_pack_16bit_le, :shared => true do
  ...
  it "encodes the least significant 16 bits of a negative number", ->
    [ [[-0x0000_0021], "\xdf\xff"],
      [[-0x0000_4321], "\xdf\xbc"],
      [[-0x0065_4321], "\xdf\xbc"],
      [[-0x7865_4321], "\xdf\xbc"]
...
describe :array_pack_32bit_le, :shared => true do
  ...
  it "encodes the least significant 32 bits of a negative number", ->
...
describe :array_pack_32bit_le_platform, :shared => true do
  it "encodes the least significant 32 bits of a number", ->
    [ [[0x7865_4321],  "\x21\x43\x65\x78"],
      [[-0x7865_4321], "\xdf\xbc\x9a\x87"]
    ].should be_computed_by(:pack, pack_format())
  ...
  platform_is :wordsize => 64 do
    it "encodes the least significant 32 bits of a number that is greater than 32 bits", ->
...
describe :array_pack_64bit_le, :shared => true do
  it "encodes the least significant 64 bits of a positive number", ->
  ...
  it "encodes the least significant 64 bits of a negative number", ->
