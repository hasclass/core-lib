...
describe "Range.new", ->
  ...
  it "includes the end object when the third parameter is omitted or false", ->
    expect( R.Range.new('a', 'c').to_a().valueOf() ).toEqual  ['a', 'b', 'c']
    expect( R.Range.new(1, 3).to_a().valueOf() ).toEqual  [1, 2, 3]

    expect( R.Range.new('a', 'c', false).to_a().valueOf() ).toEqual  ['a', 'b', 'c']
    expect( R.Range.new(1, 3, false).to_a().valueOf() ).toEqual  [1, 2, 3]

    expect( R.Range.new('a', 'c', true).to_a().valueOf() ).toEqual  ['a', 'b']
    expect( R.Range.new(1, 3, 1).to_a().valueOf() ).toEqual  [1, 2]
