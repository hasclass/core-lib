describe "Regexp#options", ->
  it "unsupported", ->
    expect( -> R(/foo/).options() ).toThrow('NotSupportedError')
...
#     it "includes Regexp::FIXEDENCODING for a Regexp primitive with the 'u' option" do
#       (//u.options & Regexp::FIXEDENCODING).should_not == 0
#     end

#     it "includes Regexp::FIXEDENCODING for a Regexp primitive with the 'e' option" do
#       (//e.options & Regexp::FIXEDENCODING).should_not == 0
#     end

#     it "includes Regexp::FIXEDENCODING for a Regexp primitive with the 's' option" do
#       (//s.options & Regexp::FIXEDENCODING).should_not == 0
#     end

#     it "does not include Regexp::FIXEDENCODING for a Regexp primitive with the 'n' option" do
#       (//n.options & Regexp::FIXEDENCODING).should == 0
#     end

#     it "includes Regexp::NOENCODING for a Regexp primitive with the 'n' option" do
