...
(function() {
  var $args, $exec, $execute, CharTable, Coerce, CoerceProto, RStrProto, method, name, nativeArray, nativeNumber, nativeObject, nativeRegExp, nativeString, previousR, root, toString, _ref,
    __slice = [].slice,
  ...
  RubyJS.Kernel = (function() {
    ...
    Kernel.prototype.box = function(obj, recursive, block) {
      ...
      var object_type, primitive_type, _t, _v;
      primitive_type = typeof obj;
      if (primitive_type === 'object') {
        ...
        if (_t !== 'object') {
          ...
          if (R.Array.isNativeArray(obj)) {
            ...
            object_type = Object.prototype.toString.call(obj);
          }
        }
      }
      if (primitive_type === 'number') {
        obj = RubyJS.Numeric.typecast(obj);
      } else if (primitive_type === 'string') {
        obj = new R.String(obj);
      } else if (object_type === '[object Array]') {
        obj = R.Array.typecast(obj, recursive);
      } else if (object_type === '[object RegExp]') {
        obj = RubyJS.Regexp.try_convert(obj);
      }
  ...
  RubyJS.Object = (function() {
    ...
    Object.prototype.to_enum = function() {
      ...
      })(RubyJS.Enumerator, [this, iter].concat(__slice.call(args)), function(){});
    };
  ...
  RubyJS.NilClass = (function(_super) {

    __extends(NilClass, _super);

    function NilClass() {
      return NilClass.__super__.constructor.apply(this, arguments);
    }

    NilClass.instance = function() {
      return new NilClass();
    };

    NilClass.prototype.nil = function() {
      return true;
    };

    NilClass.prototype.inspect = function() {
      return this.to_s();
    };

    NilClass.prototype.to_a = function() {
      return this.$Array([]);
    };

    NilClass.prototype.to_i = function() {
      return this.$Integer(0);
    };

    NilClass.prototype.to_f = function() {
      return this.$Float(0.0);
    };

    NilClass.prototype.to_s = function() {
      return this.$String('');
    };
  ...
  RubyJS.Enumerable = (function() {
    ...
    Enumerable.prototype.collect_concat = function(block) {
      ...
      return new R.Array(ary, false).flatten(1);
    };
    ...
    Enumerable.prototype.inject$args = function(initial, sym, block) {
      var _method, _ref1;
    ...
    Enumerable.prototype.inject = function(init, sym, block) {
      var _ref1;
      _ref1 = this.inject$args(init, sym, block), init = _ref1[0], sym = _ref1[1], block = _ref1[2];
      this.each(function() {
        var args;
        if (init === void 0) {
          ...
          args = arguments;
          args = args.length !== 1 ? Array.prototype.slice.call(args) : args[0];
  ...
  RubyJS.EnumerableArray = (function() {
    ...
    EnumerableArray.prototype.inject = function(initial, sym, block) {
      var args, idx, _ref1;
      _ref1 = this.inject$args(initial, sym, block), initial = _ref1[0], sym = _ref1[1], block = _ref1[2];
      idx = -1;
      while (++idx < this.__native__.length) {
    ...
    EnumerableArray.prototype.min = function(block) {
      var arr, cmp, idx, item, len, min, _max;
      min = void 0;
      block || (block = RubyJS.Comparable.cmp);
      if (typeof this.__samesame__ === "function" ? this.__samesame__() : void 0) {
        arr = this.__native__;
  ...
  RubyJS.Enumerator = (function(_super) {
    ...
    Enumerator["new"] = function() {
      ...
      return (function(func, args, ctor) {
        ...
        var child = new ctor, result = func.apply(child, args), t = typeof result;
        return t == "object" || t == "function" ? result || child : child;
      })(RubyJS.Enumerator, [obj, iter].concat(__slice.call(args)), function(){});
    };

    function Enumerator() {
      var args, iter, object;
      object = arguments[0], iter = arguments[1], args = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
      this.object = object;
  ...
  RubyJS.Array = (function(_super) {
    ...
    function Array(__native__, clone) {
      this.__native__ = __native__ != null ? __native__ : [];
    }

    Array["new"] = function() {
      var args, block, one, two, _default;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      ...
      if (two !== void 0 && (this.isNativeArray(one) || (one.is_array != null))) {
        throw R.TypeError["new"]();
      }
      if (this.isNativeArray(one)) {
        return this.typecast(one);
      }
      if ((one.to_ary != null) && two === void 0) {
        return one.to_ary();
      }
      one = CoerceProto.to_int_native(one);
      if (one < 0) {
        throw R.ArgumentError["new"]();
      }
      _default = two;
      ...
      if (block) {
        return R(0).upto(one - 1).map(function(i) {
          return block(i);
        });
      } else {
        return R(0).upto(one - 1).map(function() {
          return _default;
        });
      }
    };
      ...
      if (recursive === true) {
        arr = (function() {
          ...
          for (_i = 0, _len = arr.length; _i < _len; _i++) {
            el = arr[_i];
            _results.push(R(el, recursive));
          }
          return _results;
        })();
      }
      return new RubyJS.Array(arr, false);
    };
    ...
    Array.prototype.at = function(index) {
      ...
      if (index < 0) {
        return this.__native__[this.size() + index];
      } else {
    ...
    Array.prototype.fill = function() {
      var args, block, i, left, obj, one, right, size, total, two, v;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      if (args.length === 0) {
        throw R.ArgumentError["new"]();
      }
      ...
      total = right;
      if (right > size) {
        this.concat(R(size).upto(right - 1).to_a().map(function() {
          return null;
        }));
        total = right;
      }
    ...
    Array.prototype.insert = function() {
      ...
      if (idx > before.length) {
        before = before.concat((function() {
          var _i, _ref1, _results;
          _results = [];
          for (i = _i = 0, _ref1 = idx - before.length; 0 <= _ref1 ? _i < _ref1 : _i > _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
            _results.push(null);
          }
          return _results;
        })());
    ...
    Array.prototype.multiply = function(multiplier) {
      ...
      if (multiplier.to_str != null) {
        ...
        total = this.__size__();
        if (total === 0) {
          return new R.Array([], false);
        } else if (total === 1) {
          return this.dup();
        }
        ary = [];
        arr = this.__native__;
        R(multiplier).times(function() {
          return ary = ary.concat(arr);
        });
        return new R.Array(ary, false);
      }
    };
    ...
    Array.prototype.push = function() {
      var el, _ref1;
      el = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      (_ref1 = this.__native__).push.apply(_ref1, el);
      return this;
    };
    ...
    Array.prototype.rindex = function(other) {
      ...
      if (other.call != null) {
        ...
        ridx = this.catch_break(function(breaker) {
          this.reverse_each().each_with_index(function(el, idx) {
            if (!R.falsey(block(el))) {
    ...
    Array.prototype.sample = function(n, range) {
      ...
      return new R.Array(ary, false).slice(0, n);
    };
    ...
    Array.prototype.transpose = function() {
      ...
      this.each(function(ary) {
        ...
        return ary.size().times(function(i) {
          var entry;
          if (!out.at(i)) {
            out.append(R([]));
          }
          entry = out.at(i);
          return entry.append(ary.at(i));
        });
      });
      return out;
    };
  ...
  RubyJS.String = (function(_super) {
    ...
    String.prototype.chars = function(block) {
      ...
      R(this.__char_natives__()).each(block);
      return this;
    };
    ...
    String.prototype.chop = function() {
      ...
      if (this.end_with("\r\n")) {
        return this.$String(this.to_native().replace(/\r\n$/, ''));
      } else {
  ...
  RubyJS.Regexp = (function(_super) {
    ...
    Regexp.isRegexp = function(obj) {
      return Object.prototype.toString.call(obj) === '[object RegExp]' || (obj.is_regexp != null);
    };
    ...
    Regexp.prototype.match = function(str, offset) {
      ...
      block = this.__extract_block(Array.prototype.slice.call(arguments));
      if (str === null) {
        R['$~'] = null;
      } else {
  ...
  RubyJS.Numeric = (function(_super) {
    ...
    Numeric.typecast = function(value) {
      if (value % 1 === 0) {
        return new RubyJS.Fixnum(value);
      } else {
        return new RubyJS.Float(value);
      }
    };
    ...
    Numeric.prototype.toInt = Numeric.prototype.to_int;
  ...
  RubyJS.Integer = (function(_super) {
    ...
    Integer.prototype.gcdlcm = function(other) {
      ...
      this.__ensure_args_length(arguments, 1);
      this.__ensure_integer__(other);
      return this.$Array([this.gcd(other), this.lcm(other)]);
    };
    ...
    Integer.prototype.next = function() {
      return this.plus(R.Fixnum["new"](1));
    };
    ...
    Integer.prototype.round = function(n) {
      ...
      if (n.gt(0)) {
        ...
        return this.$Integer(Math.round(this.to_native() * multiplier) / multiplier);
      }
    };
  ...
  RubyJS.Float = (function(_super) {
    ...
    Float.prototype.floor = function() {
      return new RubyJS.Fixnum(Math.floor(this.to_native()));
    };
