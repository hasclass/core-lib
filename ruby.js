...
(function() {
  ...
  ArrayMethods = (function(_super) {
    ...
    ArrayMethods.prototype.flatten = function(coll, recursion) {
      ...
      arr = [];
      _arr.each(coll, function(element) {
        var el;
        el = R(element);
